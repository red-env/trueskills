...
module.exports = {
    ...
    CAMPI_MANCANTI: new Excetion("CAMPI_MANCANTI"),
    ...
    CERTIFICATO_NON_ESISTENTE: new Excetion("CERTIFICATO_NON_ESISTENTE"),
    PASSWORD_DIFFERENTI: new Excetion("PASSWORD_DIFFERENTI"),
};